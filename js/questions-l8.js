    ...
    "kp8_03": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "answer": 2,
          "explanation": "边界全为1，递推a[x][y]=a[x-1][y]+a[x][y-1]正是杨辉三角与组合数C(x+y,x)，故a[5][4]=C(9,5)=C(9,4)=126，输出126，选C。",
          "source": "GESP2024-03",
          "isJudge": false,
          "answerText": null,
          "starterCode": null,
      ...
      "questions": [
        {
          ...
          "type": "choice",
          "difficulty": 1,
          "question": "下面程序的时间复杂度为（  ）。\n<pre><code>long long power_mod(long long a, long long n, long long mod) {\n    if (n == 0) return 1;\n    a = a % mod;\n    if (n == 1) return a;\n    long long pw = power_mod(a, n / 2, mod);\n    long long pw2 = pw * pw % mod;\n    if (n % 2 == 0) return pw2;\n    return pw2 * a % mod;\n}</code></pre>",
          "options": [
            "O(n)",
            "O(an)",
            "O(log(n))",
        ...
        },
        {
          ...
          "type": "choice",
          "difficulty": 1,
          "question": "下列代码实现了快速幂算法，其时间复杂度为（ ）。\n<pre><code>long long fastPow(long long b, long long e, long long mod) {\n    long long result = 1;\n    while (e > 0) {\n        if (e & 1) result = result * b % mod;\n        b = b * b % mod;\n        e >>= 1;\n    }\n    return result;\n}</code></pre>",
          "options": [
            "O(e)",
            "O(log e)",
            "O(1)",
    ...
    "kp8_06": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "answer": 0,
          "explanation": "朴素Dijkstra每次线性找最小顶点，复杂度O(v²)；用二叉堆或优先队列维护待选顶点可优化到O(e+v·log v)，说法正确。最短路、最小生成树、连通性、树与LCA等图论算法的原理、实现与复杂度都要掌握。",
          "source": "GESP2024-06",
          "isJudge": true,
          "answerText": null,
          "starterCode": null,
        ...
        },
        {
          ...
          "type": "choice",
          "difficulty": 1,
          "question": "下列Dijkstra算法中，横线处应该填入的是（  ）。\n<pre><code>for (Edge * e = graph[minv]; e != NULL; e = e->next) {\n    ________;\n}</code></pre>",
          "options": [
    ...
    "kp8_07": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "type": "choice",
          "difficulty": 1,
          "question": "下面程序的时间复杂度为（  ）。\n<pre><code>bool notPrime[N] = {false};\nvoid sieve() {\nfor (int n = 2; n * n < N; n++)\nif (!notPrime[n])\nfor (int i = n * n; i < N; i += n)\nnotPrime[i] = true;\n}</code></pre>",
          "options": [
            "O(N)",
            "O(N×log N)",
            "O(N×log(log N))",
        ...
        },
        {
          ...
          "answer": 1,
          "explanation": "static成员变量属于类与结构体，所有对象共享同一份存储，不包含在单个对象中，说法错误。分析时空复杂度要抓住循环层数与数据规模，选对排序、哈希、DP与筛法等优化手段。",
          "source": "GESP2026-03",
          "isJudge": true,
          "answerText": null,
          "starterCode": null,
