    ...
    "kp5_01": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "试题名称：终止数计数\n时间限制：1.0 s\n内存限制：128.0 MB\n\n【问题描述】\n一个正整数 n，如果分数 1÷n 能化为一个有限小数（也就是小数部分有限、不循环），那么称 n 为终止数。\n例如 1÷2 = 0.5、1÷4 = 0.25、1÷5 = 0.2 都是有限小数，所以 2、4、5 都是终止数；而 1÷3 = 0.333…、1÷7 = 0.142857… 的小数部分无限循环，所以 3、7 不是终止数。\n给定两个正整数 l 和 r，请你求出在 l 到 r 之间（含 l 和 r）终止数的数量。\n\n【输入描述】\n第一行包含两个正整数 l 和 r。\n\n【输出描述】\n输出一个整数，表示在 l 到 r 之间终止数的数量。\n\n【样例输入 1】\n2 11\n\n【样例输出 1】\n5",
          "options": null,
          "answer": null,
    ...
    "kp5_04": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "试题名称：所有数加 i 的最大公因数\n时间限制：1.0 s\n内存限制：128.0 MB\n\n【问题描述】\n对于两个正整数 a、b，它们的最大公因数记为 gcd(a,b)，也就是能同时整除 a 和 b 的最大正整数。\n给定 n 个正整数 a1, a2, …, an 以及 q 组询问。对于第 i 组询问，把这 n 个数都加上 i，然后求它们共同的最大公因数，即 gcd(a1+i, a2+i, …, an+i)。\n\n【输入描述】\n第一行包含两个正整数 n 和 q，分别表示整数的个数和询问的组数。\n第二行包含 n 个正整数 a1, a2, …, an。\n\n【输出描述】\n共输出 q 行，每行一个整数。第 i 行输出所有数都加上 i 之后的最大公因数。\n【数据范围】\n1 ≤ n ≤ 100000\n\n【样例输入 1】\n5 3\n6 9 12 18 30\n\n【样例输出 1】\n1\n1\n3\n\n【样例输入 2】\n3 5\n31 47 59\n\n【样例输出 2】\n4\n1\n2\n1\n4",
          "options": null,
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "试题名称：晚宴选菜\n时间限制：1.0 s\n内存限制：128.0 MB\n\n【问题描述】\n小明去参加晚宴。晚宴中有 n 个菜肴，每个菜肴都有一个美味度。\n晚宴规定，小明只能恰好选取两道菜肴，并且这两道菜肴的美味度必须互质（也就是最大公约数为 1）。\n请你帮助小明选出两道互质的菜肴，使得两道菜肴的美味度之和最大，并输出这个最大值。\n\n【输入描述】\n第一行包含一个正整数 n，表示菜肴的数量。\n第二行包含 n 个正整数，表示每道菜肴的美味度。\n\n【输出描述】\n输出一个整数，表示选出两道互质菜肴的美味度之和的最大值。\n【数据范围】\n1 ≤ n ≤ 1000\n\n【样例输入 1】\n5\n3 5 7 35 105\n\n【样例输出 1】\n38",
          "options": null,
          "answer": null,
    ...
    "kp5_05": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "试题名称：选取最多的互质数\n时间限制：1.0 s\n内存限制：128.0 MB\n\n【问题描述】\n给定一个正整数 n，现在有 1, 2, 3, …, n 共 n 个整数。\n需要从中选取一些整数，使得所选取的整数中，任意两个不同的整数都互质（也就是最大公因数为 1）。\n请你求出最多能选取多少个整数。\n\n【输入描述】\n第一行包含一个正整数 n。\n\n【输出描述】\n输出一个整数，表示最多能选取的整数个数。\n【数据范围】\n1 ≤ n ≤ 100000\n\n【样例输入 1】\n6\n\n【样例输出 1】\n4\n\n【样例输入 2】\n9\n\n【样例输出 2】\n5",
          "options": null,
          "answer": null,
    ...
    "kp5_06": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "试题名称：变成相同整数\n时间限制：1.0 s\n内存限制：128.0 MB\n\n【问题描述】\n小A有一个包含 n 个正整数的序列。他每次可以花费 1 个金币，执行以下两种操作中的任意一种：\n1. 选择序列中的一个正整数，把它乘以任意一个质数；\n2. 选择序列中的一个正整数，把它除以任意一个质数（要求这个数能被该质数整除）。\n小A希望经过若干次操作后，序列中所有整数都变成同一个数。请你帮他计算出最少需要花费多少金币。\n\n【输入描述】\n第一行包含一个正整数 n，表示序列中整数的个数。\n第二行包含 n 个正整数，表示序列中的各个整数。\n\n【输出描述】\n输出一个整数，表示让序列中所有整数都相同的最少金币数。\n【数据范围】\n1 ≤ n ≤ 100000\n\n【样例输入 1】\n5\n10 6 35 105 42\n\n【样例输出 1】\n8",
          "options": null,
          "answer": null,
    ...
    "kp5_07": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "试题名称：兑换奖品\n时间限制：1.0 s\n内存限制：128.0 MB\n\n【问题描述】\n班主任给上课专心听讲、认真完成作业的同学们分别发放了若干张课堂优秀券和作业优秀券。\n同学们可以使用这些券兑换奖品：用 a 张课堂优秀券和 b 张作业优秀券可以兑换一份奖品，或者用 b 张课堂优秀券和 a 张作业优秀券也可以兑换一份奖品。\n现在小A有 n 张课堂优秀券和 m 张作业优秀券，他最多能兑换多少份奖品呢？\n\n【输入描述】\n第一行包含两个正整数 n 和 m，分别表示小A课堂优秀券和作业优秀券的张数。\n第二行包含两个正整数 a 和 b，含义见问题描述。\n\n【输出描述】\n输出一个整数，表示小A最多能兑换的奖品份数。\n\n【样例输入 1】\n8 8\n2 1\n\n【样例输出 1】\n5\n\n【样例输入 2】\n314159 2653589\n27 1828\n\n【样例输出 2】\n1599",
          "options": null,
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "试题名称：让相同数字相邻\n时间限制：1.0 s\n内存限制：128.0 MB\n\n【问题描述】\n小A有一个包含 n 个正整数的序列，这个序列恰好包含 n÷2 对不同的正整数，每个数字恰好出现两次。\n小A希望每一对相同的数字在序列中相邻。他每次可以选择任意一个数字，把它移动到任意位置，这一次操作花费的体力等于这个数字的数值。\n小A希望找到一个最小的整数 k，使得在每次花费的体力都不超过 k 的情况下，可以让每一对相同的数字都相邻。\n\n【输入描述】\n第一行包含一个正整数 n（n 为偶数），表示序列中整数的个数。\n第二行包含 n 个正整数，表示序列中的各个整数。\n\n【输出描述】\n输出一个整数，表示最小的 k。\n【数据范围】\n1 ≤ n ≤ 100000\n\n【样例输入 1】\n6\n1 2 1 3 2 3\n\n【样例输出 1】\n2",
          "options": null,
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "试题名称：数组公共元素\n时间限制：1.0 s\n内存限制：128.0 MB\n\n【问题描述】\n给定一个包含 n 个互不相同的正整数的数组 a，以及一个包含 m 个互不相同的正整数的数组 b。\n请你帮忙计算一下，有多少个数既在数组 a 中出现，也在数组 b 中出现。\n\n【输入描述】\n第一行包含两个正整数 n 和 m，分别表示数组 a 和数组 b 中元素的个数。\n第二行包含 n 个互不相同的正整数，表示数组 a 中的元素。\n第三行包含 m 个互不相同的正整数，表示数组 b 中的元素。\n\n【输出描述】\n输出一个整数，表示同时在数组 a 和数组 b 中都出现的数的个数。\n\n【样例输入 1】\n3 5\n4 2 3\n3 1 5 4 6\n\n【样例输出 1】\n2",
          "options": null,
          "answer": null,
    ...
    "kp5_08": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "试题名称：分糖果\n时间限制：1.0 s\n内存限制：128.0 MB\n\n【问题描述】\n老师正在和小朋友们分糖果。小朋友们先在自己的手上写一个数字，然后坐成一排，从左到右依次编号为 1 到 N。老师分发糖果的规则是：每个小朋友获得自己以及所有坐在他左侧（编号比他小）的小朋友的手上数字之和个糖果。请帮小朋友们安排合适的座位顺序，使得小朋友们分到的糖果总量最大，输出这个最大值。\n\n【输入描述】\n第一行包含一个正整数 N，表示小朋友的人数。\n第二行包含 N 个整数，依次表示每个小朋友手上写的数字。\n\n【输出描述】\n输出一个整数，表示分到糖果总量的最大值。\n\n【数据范围】\n1 ≤ N ≤ 1000\n\n【样例输入 1】\n5\n7 5 8 9 3\n\n【样例输出 1】\n111",
          "options": null,
          "answer": null,
    ...
    "kp5_09": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "试题名称：有趣的整数之和\n时间限制：1.0 s\n内存限制：128.0 MB\n\n【问题描述】\n如果一个正整数的二进制表示中恰好包含奇数个 1，那么小A就会认为这个正整数是有趣的。\n例如 4 的二进制是 100，包含 1 个 1（奇数个），所以 4 是有趣的；6 的二进制是 110，包含 2 个 1（偶数个），所以 6 不是有趣的。\n给定两个正整数 l 和 r，请你统计所有满足 l ≤ x ≤ r 的有趣的整数 x 之和。\n\n【输入描述】\n第一行包含两个正整数 l 和 r。\n\n【输出描述】\n输出一个整数，表示区间 [l, r] 内所有有趣的整数之和。\n\n【样例输入 1】\n3 8\n\n【样例输出 1】\n19\n\n【样例输入 2】\n65 36248\n\n【样例输出 2】\n328505490",
          "options": null,
          "answer": null,
