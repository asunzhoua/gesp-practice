    ...
    "kp6_01": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "小杨的握手问题。小杨的班级里共有N名同学，学号从0至N-1。老师安排了一个顺序，让全班N名同学依次进入教室。每位同学进入教室时，需要和已经在教室内且学号小于自己的同学握手。求整个班级总共会进行多少次握手。",
          "options": [],
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "树上游走。小杨有一棵包含无穷节点的二叉树，每个节点都有左儿子和右儿子，根节点编号为1，节点x的左儿子编号为2x，右儿子编号为2x+1。小杨从节点s开始移动n次，每次为三种方式之一：U（有父节点则上移一层，根节点则不移动）、L（移到左儿子）、R（移到右儿子）。求移动n次后所处的节点编号。",
          "options": [],
          "answer": null,
    ...
    "kp6_07": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "工作沟通。某公司有N名员工，编号从0至N-1，0号是老板，编号i的员工直接领导是fi。规定员工x可以管理员工y，当且仅当x=y，或x=fy，或x可以管理fy。现在有Q场合作，每场给出参与员工，需要找到能管理所有参与者的编号最大的员工（若多人满足取编号最大）。",
          "options": [],
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "二叉树。小杨有一棵包含n个节点的二叉树，且根节点的编号为1。这棵二叉树任意一个节点要么是白色(0)，要么是黑色(1)。之后小杨会对这棵二叉树进行q次操作，每次小杨会选择一个节点，将以这个节点为根的子树内所有节点的颜色反转，即黑色变成白色，白色变成黑色。求q次操作全部完成之后每个节点的颜色。",
          "options": [],
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "树上漫步。小A有一棵n个结点的树，结点以1..n标号。小A会从树上的某个结点出发，每一步可以移动到与当前结点相邻的结点，并且小A只会在偶数步（可以是零步）后结束漫步。求对于树上的每个结点，从这个结点出发开始漫步，经过偶数步能结束漫步的结点有多少个（可以经过重复的节点）。",
          "options": [],
          "answer": null,
    ...
    "kp6_10": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "小杨买饮料。小杨来到了一家商店，打算购买一些饮料。这家商店总共出售N种饮料，编号从0至N-1，其中编号为i的饮料售价ci元，容量li毫升。小杨的需求：1.每种饮料至多购买1瓶；2.购买总容量不低于L；3.在1和2的前提下使用尽可能少的费用。输出最少花费的费用，如果不能则输出no solution。",
          "options": [],
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "闯关游戏。这个游戏总共有N关，每关都有M个通道，第i个通道可以让你前进ai关，即若你在第x关，选择第i个通道后你将直接来到第x+ai关（若x+ai≥N则通关）。当你顺利离开第S关时，你将获得bs分。游戏开始时你在第0关，求通关时最多能获得多少总分。",
          "options": [],
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "游戏。你有四个正整数n、a、b、c，并准备用它们玩一个简单的小游戏。在一轮游戏操作中，你可以选择将当前数x减去a，或是将x减去b。游戏将会进行多轮操作，直到当x≤c时游戏结束。你想知道游戏结束时有多少种不同的游戏操作序列（若a=b，也认为减去a与减去b是不同的操作）。由于答案可能很大，你只需要求出答案对1e9+7取模的结果。",
          "options": [],
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "计算得分。小杨想要计算由m个小写字母组成的字符串的得分。小杨设置了一个包含n个正整数的计分序列a[1..n]，如果字符串的一个子串由k(k≤n)个abc首尾相接组成，那么能够得到分数a[k]，并且字符串包含的字符不能够重复计算得分，整个字符串的得分是计分子串的总和。求给定字符串的最大总得分。",
          "options": [],
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "小杨和整数拆分。小杨有一个正整数n，小杨想将它拆分成若干完全平方数的和，同时希望拆分的数量越少越好。请你编写程序计算出总和为n的完全平方数的最少数量。",
          "options": [],
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "算法学习。小杨计划学习m种算法，为此他找了n道题目来帮助自己学习，每道题目至多学习一次。小杨对每种算法的初始掌握程度均为0。第i道题目有对应的知识点a[i]，即学习第i道题目可以令小杨对第a[i]种算法的掌握程度提高b[i]。学习目标是对m种算法的掌握程度均至少为k。小杨认为连续学习两道相同知识点的题目是不好的，请你帮他计算出他最少需要学习多少道题目才能在完成学习目标的同时避免连续学习两道相同知识点的题目，如果不存在输出-1。",
          "options": [],
          "answer": null,
    ...
    "kp6_13": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "好斗的牛。你有N个牛棚，从左到右一字排开，希望把N头牛安置到牛棚里。第i头牛的攻击范围是：左边a[i]个牛棚或右边b[i]个牛棚内有其他牛就会挑事。你想留下连续的一段牛棚，并把其他牛棚都卖掉。请问最少需要留下多少牛棚，才能保证至少存在一种方案能够把所有N头牛都安置进剩余的牛棚里且没有牛会挑事？",
          "options": [],
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "运送物资。小杨管理着m辆货车，每辆货车每天需要向A市和B市运送若干次物资。小杨同时拥有n个运输站点，位于A市和B市之间，A市坐标为0，B市坐标为x，第i个运输站点位置为p[i]且至多作为c[i]辆货车的初始运输站点。第j辆货车每天向A市运送a[j]次、向B市运送b[j]次。求在最优分配每辆货车初始运输站点的情况下，所有货车每天的最短总行驶路程。",
          "options": [],
          "answer": null,
        ...
        },
        {
          ...
          "type": "coding",
          "difficulty": 1,
          "question": "环线。小A喜欢坐地铁。地铁环线有n个车站，依次以1..n标号，车站i（1≤i<n）的下一个车站是车站i+1，车站n的下一个车站是车站1。小A会从某个车站出发，乘坐地铁环线到某个车站结束行程，至少经过一个车站，且不会经过一个车站多次。当小A经过车站i时会获得a[i]点快乐值。请安排行程，选择出发车站与结束车站，使得获得的快乐值总和最大。",
          "options": [],
          "answer": null,
